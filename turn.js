    ...
    var initiate = function(heroName){
        ...
        return {
            ...
            attackMonster: function(){
                ...
                document.getElementById('monster-hp').innerHTML = 'HP: ' + monster.hp;
                if(monster.hp > 0){
                    return this.setMessage(hero.att + '의 데이지를 입혔습니다.').nextTurn();
                }
                return this.win();
            },
            attackHero: function(){
            ...
            gameOver: function(){
                document.getElementById('screen').innerHTML = hero+'은 레벨'+hero.lev + '에서 죽었습니다. 새로 시작하려면 새로고침을 눌러주세요';
                return false;
            },
            exit: function(input){
                document.getElementById('screen').innerHTML = '이용해주셔서 감사합니다.'
            }
        };
    };
    return {
